...
class="fixed text-zinc-600 flex top-0 bg-cyan-500 w-full justify-between py-1 shadow-lg rounded-b-lg z-10">
    ...
    ">
        ...
        @foreach ($categories as $category)
            <div class="menu-item group">
                ...
                <div class="hidden group-hover:block absolute top-full right-0 whitespace-nowrap rounded-b-md text-right bg-cyan-500 py-4">
                    @php
                    ...
                    @foreach($childCategories as $childCategory)
                        <div class="mx-8 mt-2 mb-2 cursor-pointer capitalize tracking-wider">
                            <a href="{{ route('categories.view-products-by-category', $childCategory->slug) }}" class="hover:border-b hover:border-cyan-700 px-2 text-lg">{{ $childCategory->name }}</a>
                        </div>
                    @endforeach
                    <div class="mx-8 mt-2 mb-2 cursor-pointer capitalize">
                        <span class="text-sm font-semibold uppercase hover:border-b hover:border-cyan-700 px-2 tracking-tight">view all</span>
                    </div>
                </div>
            </div>
        @endforeach
    ...
    <div class="flex justify-end items-end text-white-500 gap-4 text-lg">
        <div>
            <a href="{{ route('cart.index') }}" class="relative inline-flex items-center hover:bg-rose-400">
                <svg
        ...
        @if(!Auth::guest())
            <li x-data="{open:false}" class="relative list-none">
                <a @click="open = !open" class="p-3 pb-1 flex items-center justify-center md:text-lg cursor-pointer hover:bg-rose-600">
                ...
                <ul @click.outside="open = false"
                    ...
                    <li>
                        <a href="#"
                           class="flex px-4 py-2 hover:bg-rose-400 ">
                           <svg
                           xmlns="http://www.w3.org/2000/svg"
                           class="h-5 w-5 mr-2"
                           fill="none"
                        ...
                        <li>
                            <a
                              href="#"
                              class="flex px-3 py-2 hover:bg-rose-400"
                            >
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                class="h-5 w-5 mr-2"
